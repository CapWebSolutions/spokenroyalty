...
//* Future: go through an array of custom fields specifying images. Enables client to modify from dashboard. 
	...
	printf('<div class="horizontally-lr"><figure class="figs"><img src="%s/poet-lady.jpg" alt="" width="850" height="600" class="alignnone size-full wp-image-1027" srcset="%s/poet-lady.jpg 850w, %s/poet-lady-300x212.jpg 300w, %s/poet-lady-768x542.jpg 768w" sizes="(max-width: 850px) 100vw, 850px"><figcaption>Poet Lady</figcaption></div>',$poet_pics_dir, $poet_pics_dir, $poet_pics_dir, $poet_pics_dir);
	...
	printf('<div class="diagonally2"><figure class="figs"><img src="%s/poet-giovanni.jpg" alt="" width="800" height="600" class="alignnone size-full wp-image-1031" srcset="%s/poet-giovanni.jpg 800w, %s/poet-giovanni-300x225.jpg 300w, %s/poet-giovanni-768x576.jpg 768w" sizes="(max-width: 800px) 100vw, 800px"><figcaption>Poet Giovanni</figcaption></div>',$poet_pics_dir, $poet_pics_dir, $poet_pics_dir, $poet_pics_dir); 
	...
	printf('<div class="diagonally1"><figure class="figs"><img src="%s/poet-lh.jpg" alt="" width="948" height="600" class="alignnone size-full wp-image-1029" srcset="%s/poet-lh.jpg 948w, %s/poet-lh-300x225.jpg 300w, %s/poet-lh-768x576.jpg 768w" sizes="(max-width: 948px) 100vw, 948px"><figcaption>Poet LH</figcaption></div>',$poet_pics_dir, $poet_pics_dir, $poet_pics_dir, $poet_pics_dir);
