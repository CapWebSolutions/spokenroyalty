...
function cws_scripts_and_styles() {

   	// register our stylesheet
	wp_register_style( 'cws-stylesheet', get_stylesheet_directory_uri() . '/style.css', array(), '', 'all' );
    ...
    wp_register_script( 'cws-modernizr', get_stylesheet_directory_uri() . '/js/modernizr.custom.min.js', '', '2.8.3' );

    // Register scripts to load in site footer
    wp_register_script( 'cws-js', get_stylesheet_directory_uri() . '/js/scripts.js', array( 'jquery' ), '' );
    wp_register_script( 'cws-sidr', get_stylesheet_directory_uri() . '/js/jquery.sidr.min.js', array( 'jquery' ), '', true );

    // Enqueue styles
    wp_enqueue_style( 'cws-stylesheet' );
    wp_enqueue_style( 'fontawesome' );

    // Enqueue scripts
    wp_enqueue_script( 'jquery' );
    wp_enqueue_script( 'cws-js' );
    wp_enqueue_script( 'cws-modernizr' );
    wp_enqueue_script( 'cws-sidr' );
 ...
 */
function cws_dont_update( $r, $url ) {
